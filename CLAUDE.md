...
MCP (Model Context Protocol) server that provides secure remote terminal/command execution capabilities. Exposes system shell tools through the MCP protocol for AI assistant integration.

## Tech Stack

- **Language**: Python 3.11+
- **Framework**: MCP Python SDK (official Anthropic library)
- **Async**: asyncio
- **Validation**: pydantic
- **Testing**: pytest
- **Linting**: ruff
...
- **Co-pilot** — discuss before acting. Summarize your proposed plan. Wait for user confirmation before dispatch
...
- python-mcp-supervisor (Tessa) - Python MCP server specialist
- merge-supervisor
